...
export default function Instructions() {
	...
	useEffect(() => {
		setOpen(window.matchMedia("screen and (min-width: 48rem)").matches);
	}, []);
		...
		<div className="col-2 flex flex-col items-center gap-2">
			...
			>
				...
				<ul className="flex list-disc flex-col gap-1 px-2">
					...
					<li>
						<span className="mr-1 rounded bg-green-700 p-0.25 px-1 text-white">
							Vihreä
						</span>
						tarkoittaa, että kirjain on oikeassa kohdassa sanaa.
					</li>
					<li>
						<span className="mr-1 rounded bg-yellow-500 p-0.25 px-1 text-black">
							Keltainen
						</span>
